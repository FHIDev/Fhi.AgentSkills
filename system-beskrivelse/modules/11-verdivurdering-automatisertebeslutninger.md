...
**Produserer:** `{systemnavn}/03-vurderinger/03_verdivurdering-automatiserte-beslutninger.md`
...
*Basert på behandlingsaktiviteter fra [01_funksjoner](../01-funksjonell-beskrivelse/01_funksjoner.md).*
...
---
*Sist oppdatert: {dato} | Forrige: [03_verdivurdering-personvern](./03_verdivurdering-personvern.md) | Neste: [03_trusselvurdering](./03_trusselvurdering.md)*
```
...
- Spør til slutt: *"Vil du fortsette med 03_trusselvurdering.md, eller er det noe her som skal justeres?"*
