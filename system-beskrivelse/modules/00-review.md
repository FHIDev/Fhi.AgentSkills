...
### K1 — Komponentnavn
Navnene på komponenter i `02_komponenter.md` skal brukes konsekvent i
`02_dataflyt.md` og vurderingsfilene. Avvik: ulike navn for samme komponent.

### K2 — Behandlingsaktiviteter
Aktivitetene i `01_funksjoner.md` skal dekke alle aktiviteter som refereres i
`03_verdivurdering-kit.md` og `03_verdivurdering-personvern.md`.
Avvik: aktivitet nevnt i vurdering, men mangler i 01_funksjoner, eller omvendt.

### K3 — KIT og GDPR-annotasjoner i 01_funksjoner
Etter at `03_verdivurdering-kit.md` og `03_verdivurdering-personvern.md` er kjørt
skal `01_funksjoner.md` være oppdatert med KIT-nivå og GDPR-grunnlag per
aktivitet. Avvik: manglende eller motstridende annotasjoner.

### K4 — Sikkerhetsgradering i 00_oversikt
Etter `03_verdivurdering-sikkerhetsgradering.md` skal `00_oversikt.md` inneholde
...
Informasjonsobjektene i `02_informasjonsmodell.md` skal gjenkjennes i
`02_dataflyt.md`. Avvik: objekt beskrevet i modellen men aldri nevnt i
dataflyten, eller omvendt.

### K6 — Eksterne systemer
Eksterne systemer nevnt i `02_dataflyt.md` (integrasjoner) skal finnes igjen
i `02_komponenter.md` eller være eksplisitt markert som utenfor scope.
