...
| `helpText` / `help-text` under label; krever label ved ikke-tom hjelpetekst | 0.44.0 | Attributt | `fhi-checkbox` | Publisert `fhi-checkbox.manifest.json` v0.44.0; `src/components/fhi-checkbox/fhi-checkbox.component.ts`; [PR #482](https://github.com/FHIDev/Fhi.Designsystem/pull/482) |
| `helpText` / `help-text` under label; krever label ved ikke-tom hjelpetekst | 0.44.0 | Attributt | `fhi-radio` | Publisert `fhi-radio.manifest.json` v0.44.0; `src/components/fhi-radio/fhi-radio.component.ts`; [PR #482](https://github.com/FHIDev/Fhi.Designsystem/pull/482) |
| Ny form-assosiert komponent `fhi-text-area` med entrypoint `./fhi-text-area` | 0.45.0 | Komponent + entrypoint | `fhi-text-area` | Publisert `package.json` og `fhi-text-area.manifest.json` v0.45.0; [PR #438](https://github.com/FHIDev/Fhi.Designsystem/pull/438) |
